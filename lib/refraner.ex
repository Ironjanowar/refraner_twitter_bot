defmodule Refraner do
  ...
  defp host, do: RefranerTwitterBot.Config.get(:refraner_bot, :refraner_server_host, "localhost")
  defp port, do: RefranerTwitterBot.Config.get(:refraner_bot, :refraner_server_port, "4000")
